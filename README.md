...
Our patch is to handle schema regiestry changes. The original code initialze the schema every time the message comes in and it will end up with each flush will only contains 1 record. 
